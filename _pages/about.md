...
Developed smartphone-based pipelines for non-contact blood pressure and SpO2 monitoring, including dual-camera PTT modeling and personalized AC-DC calibration for robust oxygen saturation estimation.
...
Participated as a core member in a lower-limb arterial obstruction diagnostic device integrating perfusion index, PATD-related parameters, and multimodal physiological signals.

- Key result: classification accuracy above **90%** in project evaluation.
...
- Email: [fujy2023@mail.sustech.edu.cn](mailto:fujy2023@mail.sustech.edu.cn)
- GitHub: [github.com/ElizabethLydia](https://github.com/ElizabethLydia)
- CV: [English CV](files/cv_en.pdf) / [Chinese CV](files/cv_zh.pdf)
